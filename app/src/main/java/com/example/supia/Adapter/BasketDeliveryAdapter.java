...
import com.example.supia.Activities.Payment.BasketDeliveryAddressListActivity;
...
public class BasketDeliveryAdapter extends BaseAdapter {

    final static String TAG = "바스켓 딜리버리 어드레스어뎁터";
    ...
    BasketDeliveryAddressListActivity basketDeliveryAddressListActivity;


    public BasketDeliveryAdapter(Context mContext, int layout, ArrayList<UserDeliveryAddrDto> mDataset) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {//ListView를 보여주는곳
        View view = inflater.inflate(R.layout.listlayout_delivery_address_basket, null);//listlayout과 통신을 해준다.
        TextView deliveryName = view.findViewById(R.id.tv_deliveryName_dlistlayout_basket);//view를 넣어야 findviewid가 활성화 된다.(listview에 있는 id값이기 때문)
        TextView deliveryAddress = view.findViewById(R.id.tv_deliveryaddress_dlistlayout_basket);
        TextView deliveryAddressDetail = view.findViewById(R.id.tv_deliveryaddressDetail_dlistlayout_basket);
        TextView deliveryTel = view.findViewById(R.id.tv_deliverytel_dlistlayout_basket);
        ...
        btnModify = view.findViewById(R.id.btn_moveModify_dlistlayout_basket);
        btnDelete = view.findViewById(R.id.btn_deleteAdress_dlistlayout_basket);
        btnMoveNext = view.findViewById(R.id.btn_movePayment_dlistlayout_basket);
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                new AlertDialog.Builder(mContext)
                                        ...
                                        .setPositiveButton("닫기", new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialog, int which) {
                                                Intent intent = new Intent(mContext, BasketDeliveryAddressListActivity.class);
                                                mContext.startActivity(intent);
                                            }
                                        })
                                        .show();
        ...
        btnMoveNext.setOnClickListener(new View.OnClickListener() {//선택
            ...
            public void onClick(View v) {
                Log.d(TAG,"확인");
                Intent intent2 = new Intent(mContext, BasketPurchaseCheckActivity.class);//배송지를 선택했다면 그부분으로 넘어간다.
