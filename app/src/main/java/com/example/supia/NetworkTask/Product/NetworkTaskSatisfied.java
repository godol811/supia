...
public class NetworkTaskSatisfied extends AsyncTask<Integer, String, String> {
    ...
    public NetworkTaskSatisfied(Context context, String mAddr, String where) {
    ...
    private String parserSelect(String s) {
        ...
        try {
            ...
            JSONArray jsonArray = new JSONArray(jsonObject.getString("buy"));

            Log.v(TAG, "s" + s);
            for (int i = 0; i < jsonArray.length(); i++) {
                JSONObject jsonObject1 = (JSONObject) jsonArray.get(i);

                cnt = jsonObject1.getString("cnt");
