...
public class MyPageSubscribeNetworkTask extends AsyncTask<Integer, String, Object> {

    final static String TAG = "네트워크타스크";
    Context context = null;
    String mAddr = null;
    ProgressDialog progressDialog = null;
    ArrayList<MySubscribeDto> Address;
    ///////////////////////////////////////////////////////////////////////////////////////
    // Date : 2020.12.25
    //
    // Description:
    ...
    public MyPageSubscribeNetworkTask(Context context, String mAddr, String where) {
        this.context = context;
        this.mAddr = mAddr;
        this.Address = new ArrayList<MySubscribeDto>();
        this.where = where;
    ...
    private void parserSelect(String s) {
        ...
        try {
            ...
            JSONArray jsonArray = new JSONArray(jsonObject.getString("subscribeOrder,product"));
            Address.clear();
            Log.v(TAG, "s" + s);
