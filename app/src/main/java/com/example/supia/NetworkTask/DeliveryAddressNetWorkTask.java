...
public class DeliveryAddressNetWorkTask extends AsyncTask<Integer, String, Object> {

    final static String TAG = "네트워크타스크";
    Context context = null;
    String mAddr = null;
    ProgressDialog progressDialog = null;
    ArrayList<UserDeliveryAddrDto> Address;
    ///////////////////////////////////////////////////////////////////////////////////////
    // Date : 2020.12.25
    //
    // Description:
    ...
    public DeliveryAddressNetWorkTask(Context context, String mAddr, String where) {
        this.context = context;
        this.mAddr = mAddr;
        this.Address = new ArrayList<UserDeliveryAddrDto>();
        this.where = where;
    ...
    private void parserSelect(String s) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                int deliveryNo = Integer.parseInt(jsonObject1.getString("deliveryNo"));
                String userId = jsonObject1.getString("userId");
                String deliveryAddr = jsonObject1.getString("deliveryAddr");
                String deliveryTel = jsonObject1.getString("deliveryTel");
                String deliveryDetail = jsonObject1.getString("deliveryAddrDetail");
                String deliveryName = jsonObject1.getString("deliveryName");


               UserDeliveryAddrDto address = new UserDeliveryAddrDto(deliveryNo,userId,deliveryAddr,deliveryDetail,deliveryTel,deliveryName);
                Address.add(address);
